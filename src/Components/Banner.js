    ...
    <Slider className="slider" {...settings}>
      ...
      <div className="banner_container">
        ...
        <div className="banner_description">
          ...
          <br />
          <p>
            The film is about the rebellious early days of cinema's most
            notorious and fashionable villains, the legendary Cruella de Vil.
          </p>
        </div>
      </div>
      <div className="banner_container">
        ...
        <div className="banner_description">
          ...
          <br />
          <p>
            The movie is a coming-of-age story about one young boy experiencing
            an unforgettable summer filled with gelato, pasta and endless
            scooter rides.
          </p>
        </div>
      </div>
      <div className="banner_container">
        ...
        <div className="banner_description">
          ...
          <br />
          <p>
            What If…? flips the script on the MCU, reimagining famous events
            from the films in unexpected ways.
          </p>
        </div>
      </div>
    </Slider>
